...
int main(int argc, char **argv)
{
  ...
  dst_pnt[0] = cvPoint2D32f(124.0, 110.0);
  dst_pnt[1] = cvPoint2D32f(124.0, 208.0);
  dst_pnt[2] = cvPoint2D32f(196.0, 208.0);
  dst_pnt[3] = cvPoint2D32f(196.0, 110.0); */
  ...
  while (1) {
    ...
    if (topContoursInfo[0].area > 0.0) {
      mvprintw(0,0,"Yellow contour:");
      mvprintw(1,2,"center :  (%3d,",(int)topContoursInfo[0].oblique.center.x);
      mvprintw(1,17,"%3d)",(int)topContoursInfo[0].oblique.center.y);
      mvprintw(2,2,"width  :%6d",(int)topContoursInfo[0].oblique.size.width);
      mvprintw(3,2,"height :%6d",(int)topContoursInfo[0].oblique.size.height);
      mvprintw(4,2,"angle  :%6d",(int)topContoursInfo[0].oblique.angle);
      mvprintw(5,2,"area   :%6d",(int)topContoursInfo[0].obliqueArea);
      mvprintw(6,0,"Green contour:");
      mvprintw(7,2,"width  :%6d",(int)topContoursInfo[0].horizontal.width);
      mvprintw(8,2,"height :%6d",(int)topContoursInfo[0].horizontal.height);
      mvprintw(9,2,"area   :%6d",(int)topContoursInfo[0].horizontalArea);
    }
    refresh();
